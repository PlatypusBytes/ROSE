...
class CoupledTrainTrackPerfectContact(GlobalSystem):
    """
    ...
    """
    def __init__(self):
        super(CoupledTrainTrackPerfectContact, self).__init__()
    ...
    def update_force_vector_contact(self, u: np.ndarray, t: int, F: np.ndarray) -> np.ndarray:
        ...
        self.train.set_dirichlet_values(t, disp_at_wheels)
        self.train.ca


        #todo caclulate train behaviour and return reaction forces
    ...
    def __check_train_position(self, rail_nodes: List):
        ...
        # precision is machine float32 epsilon
